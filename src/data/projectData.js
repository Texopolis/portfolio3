...
const projects=[
    ...
    {
        "title": "In Progress...",
        "description": "This is an application which allows users to mint unique NFTs and display all NFT assets held in their Ethereum wallet. I wrote a solidity contract which generates and mints random NFTs when called and a frontend to interact with the contract and display those newly minted assets. I am using Hardhat, React and ethers.js as the main tech in development.",
