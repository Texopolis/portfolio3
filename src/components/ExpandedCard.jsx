    ...
    <motion.div 
      ...
      <div className="links">
                  <div className="site-link-container">
                    {props.url && <a href={props.url} target="_blank" className="live-site-link">Live site</a>}
                    {props.metamask && <div className="metamask">
                      <p className="metamask-text">*requires MetaMask</p>
                      <a href="https://metamask.io/" target="blank">
                        <img width="64" src="https://upload.wikimedia.org/wikipedia/commons/3/36/MetaMask_Fox.svg"/>
                      </a>
                    </div>}
                  </div>
                  {props.code && <a href={props.code} target="_blank" className="code-link">Code</a>}
